...
export function parseArgs<T>(eargs: yargs.Argv) {
  return eargs
    .help("help")
    .alias("h", "help")
    .wrap(Math.min(160, eargs.terminalWidth()))
    .parseSync(process.argv.slice(2)) as any as ParsedArgsT & T;
}

export const parsedArgs = parseArgs(makeArgs());

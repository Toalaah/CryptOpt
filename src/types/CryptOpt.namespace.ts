...
export const OPTIMIZER_STRATEGY_BIASED = "biased";
export const OPTIMIZER_STRATEGIES = [
  OPTIMIZER_STRATEGY_RLS,
  OPTIMIZER_STRATEGY_SA,
  OPTIMIZER_STRATEGY_TABU,
...
export const SA_NEIGHBOR_STRATEGY_GREEDY = "greedy";
export const SA_NEIGHBOR_STRATEGIES = [
  SA_NEIGHBOR_STRATEGY_UNIFORM,
  SA_NEIGHBOR_STRATEGY_WEIGHTED,

...
export const LOG_EVERY = 20; // log line (to screen and file) every 20 percent, if this var it set to 20, I guess must be a multple of PRINT_EVERY
// the higher that number, the more logs.
